...
export default function TodoItem({ todo, toggle, loadTodos }) {
  ...
  const saveTodo = async () => {
    ...
    try {
      await updateTodo(todo.id, { title: val, isDone: todo.isDone });
      setEditing(false);
      await loadTodos();
    } catch (err) {
    ...
    <li>
      ...
      <div className={styles.buttons}>
        {editing ? (
          ...
          <button className={styles.deleteButton} type="button" onClick={removeTodo}>
